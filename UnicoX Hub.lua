local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/XiaoYunCN/LOL/main/Orion.lua", true))()
 local Window =   OrionLib:MakeWindow({Name = "UnicoX Hub", HidePremium = false, SaveConfig = false, ConfigFolder = "rbxassetid://6026568198"}) 

 OrionLib:MakeNotification({ 
 Name = "UnicoX Hub", 
 Content = "欢迎使用UnicoX Hub", 
...
LOL:AddLabel("作者秋山")
LOL:AddLabel("作者QQ:1295411667")
LOL:AddLabel("UnicoX Hub群号:295683557")
LOL:AddLabel("脚本持续更新")
