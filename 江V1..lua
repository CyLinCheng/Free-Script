local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/XiaoYunCN/LOL/main/Orion.lua", true))()
 local Window =   OrionLib:MakeWindow({Name = "江ScriptV1", HidePremium = false, SaveConfig = false, ConfigFolder = "rbxassetid://6026568198"}) 

 OrionLib:MakeNotification({ 
 Name = "江ScriptV1", 
 Content = "欢迎使用江ScriptV1！", 
...
LOL:AddLabel("作者:凌晨")
LOL:AddLabel("QQ:1298521996")
LOL:AddLabel("江Script交流群:836843047")
