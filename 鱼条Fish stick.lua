...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/BINjiaobzx6/BINjiao/main/XK%E7%94%A8%E6%88%B7%E7%95%8C%E9%9D%A2.txt", true))()
    local window = library:new("鱼条Fish stick脚本")
    ...
    setclipboard("3623422062")
end)
    bin:Button("复制主群", function()
    setclipboard("1067428076")
end)
...
local function HeartbeatUpdate()
	...
	FpsLabel.Text = ("Fish Stick:"..os.date("%H").."时"..os.date("%M").."分"..os.date("%S")).."秒"
end
Start = tick()
